...
ggplot(all_data[all_data$step_transitions == 1 & all_data$steps == 7,], aes(x = strategy, y = step_payoff, color = strategy)) +
  geom_jitter(position = position_jitter(width = 0.2, height = 0), alpha = 0.6) +
  ...
  labs(title = "Expected Payoff Per Step for Unconstrained Structures",
       subtitle = paste0("Number of Nodes: ", data$num_nodes[1]),
       x = "Strategy",
       y = "Payoff per Step") +
